...
// messages re�us par la fen�tre Serveur TFTP
enum {
...
// messages re�us par la fen�tre Serveur BOOTP
enum {
...
// messages re�us par la fen�tre Serveur SYSLOG
enum {
...
// messages re�us par la fen�tre Serveur SNTP
enum {
...
// Message re�us par la fen�tre Gauge
enum {
       WM_NEWPOS = (WM_USER+500),
       WM_FILLWND,
};
// Message re�us par la fen�tre du Client TFTP
enum {
...
// messages re�us par la fen�tre adresse IP
enum {
        WM_TFTP_GETIP = (WM_USER+700),
        WM_IPADDRESS,
};

// messages re�us par la fen�tre adresse CMsgBox
enum {
